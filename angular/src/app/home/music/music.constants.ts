export class MusicConstants {
  public static particleStyle = {
    position: 'absolute',
    width: '100%',
    height: '100%',
    'z-index': -1,
  ...
  public static albums = [
    {
      name: 'Existence',
      story: 'Stories begin at same point. Everyone have all colors like a light. Than each one receives different' +
      ...
      songs: ['Genesis', 'Nascent', 'Altarf', 'The Mettle of Desire', 'Undesired Strikes', '7.05', 'Unexpected Descent',
        'Renaissance', 'Cycle'],
      songConstant: 'existenceSongs',
      spotify: 'https://open.spotify.com/embed/album/6UaqgH5DTCwzIWJYoQbRLG',
      soundcloud: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/18336806&amp;auto' +
    ...
    {
      name: 'Dualities',
      story: 'Life is about choices. It has other way everytime. Choosing a way leads to a result. But it breaks ' +
      ...
      songs: ['Homeostasis', 'Walk Through Silence', 'Gloomy Biding', 'Equinox', 'Chonps', 'Threshold',
        'Flowing Inside Genuineness', 'Bleak Fray', 'Into The Farewell'],
      songConstant: 'dualitiesSongs',
      spotify: 'https://open.spotify.com/embed/album/7qtXuWo6do60Z906VJs6GM',
      soundcloud: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/124549927&amp;auto' +
        '_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;' +
        'visual=true',
      theme: ''
    },
    {
      name: 'Ossify',
      story: 'Which one is the truth, we can\'t know. Are these bars real or we create all these traps?\n\nOnly one' +
        ' thing is certain; we must break all bars and traps.',
      songs: ['Perception', 'Movement', 'Surrounded Exists'],
      songConstant: '',
      spotify: '',
      soundcloud: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/409211462&color=%23ff5500&' +
    ...
    },
    {
      ...
      story: 'A long dark following a shiny gorgeous day. She was not happy. He was not' +
      ...
      songs: ['Awakening', 'Floue', 'Limpid Perception', 'Beyond the Border', 'Giving In', 'Reunion', 'Contemplation',
        'Road of Pale Gleam'],
      songConstant: 'simpleRepetitionsSongs',
      spotify: 'https://open.spotify.com/embed/album/1wYdUkeDWHFeEIXLzxxqeo',
      soundcloud: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/951696079%3Fsecret_token%' +
  ...
  public static simpleRepetitionsSongs = {
    'Awakening': {
      story: 'An impulse. A preparation. A revolution.\n\nIt was not a dream that he was losing. It was not a' +
        ' nightmare too. It was just a start of repetitions.',
      instruments: ['Piano']
    },
    'Floue': {
      story: 'At some dark times, outside of the bounds, inside the big swirls, try to see different. Only a' +
        ' different can bring back the glint.',
      instruments: ['Cello', 'Oboe', 'Double Bass', 'Bass Clarinet', 'Violin', 'English Horn']
    },
    'Limpid Perception': {
      story: 'In reality, every same simple touch reflects in exact same way. But from eyes, they seem very complex.' +
        ' Only a clear vision makes them visible.',
      instruments: ['Violin', 'Cello', 'Xylophone', 'Bass']
    },
    'Beyond the Border': {
      story: 'When the dark can cover the space between two distant, two different who can\'t give up to love must' +
        ' face with the force of borders.',
      instruments: ['Piano']
    },
    'Giving In': {
      story: 'Each acceptance creates a new path for another acceptance. Once the one learns to give in, there will' +
        ' be no more way to fix.',
      instruments: ['Piano']
    },
    'Reunion': {
      story: 'It was lost, started to crush and break everything. It collected more and more until it became an' +
    ...
    'Road of Pale Gleam': {
      story: 'Long time ago, it was dark that even the palest could shine like very beloved Sun of the Earth. Yet ' +
  ...
  public static dualitiesSongs = {
    ...
    'Walk Through Silence': {
      story: 'If we start a journey to success, we must go on a way that we must not hear others ideas. This never' +
    ...
    'Equinox': {
      story: 'It\'s effect is different on every different. When day gets bigger than dark, some will be happy. But' +
        ' there are ones who hate light. Each opposite feel great at least one time in a year.\n\nThis is not only' +
        ' in Equinox effect. This is life effect.',
      instruments: ['Piano']
    },
    'Chonps': {
      story: 'Chonps is a mnemonic for the main elements that occur naturally in living systems.\n\n' +
        'C(Carbon)\n' +
        'H (Hydrogen)\n' +
        'O (Oxygen)\n' +
        'N (Nitrogen)\n' +
    ...
    'Threshold': {
      story: 'When time has come, there is no wait for threshold. And when it happens, there can be a pure happiness' +
        ' or sadness.',
      instruments: ['Piano', 'Cello']
    },
    'Flowing Inside Genuineness': {
      story: 'When it\'s done, you can feel the emptiness and you feel the true happiness. This is truth.\n' +
        '\n' +
        'When you discover the truth your time has limited. You must enjoy it as much as you can.',
      instruments: ['Piano', 'Viola', 'Saxophone']
    },
    'Bleak Fray': {
      story: 'Like a hero film, every final fight we take huts fear and hope. Fighter knows in the final they\'re ' +
